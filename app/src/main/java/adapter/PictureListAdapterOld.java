...
public class PictureListAdapterOld extends BaseAdapter {
    ...
    public void setSetOnThumbnailClick(PictureListAdapterOld.setOnThumbnailClick setOnThumbnailClick) {
        this.setOnThumbnailClick = setOnThumbnailClick;
    }

    public void setSetOnDeleteImageClick(PictureListAdapterOld.setOnDeleteImageClick setOnDeleteImageClick) {
        this.setOnDeleteImageClick = setOnDeleteImageClick;
    }

    public void setSetOnLinkClick(PictureListAdapterOld.setOnLinkClick setOnLinkClick) {
        this.setOnLinkClick = setOnLinkClick;
    }

    public PictureListAdapterOld(Context context, File[] source, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!item.isFile()) {
            ...
            //
            Bitmap image = BitmapFactory.decodeFile(item.getAbsolutePath());
            //
            ...
            try {
                ...
                //
                thumbnail = BitmapFactory.decodeByteArray(exifInterface.getThumbnail(), 0, exifInterface.getThumbnail().length);
                if (exifInterface.getLatLong(latLong)) {
                    tv_lat.setText("Lat: " + latLong[0]);
                    tv_long.setText("Long: " + latLong[1]);
                    //
                    String url = "https://www.google.com/maps/search/?api=1&query=" + latLong[0] + "," + latLong[1];
